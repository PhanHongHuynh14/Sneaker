...
<div class="container">
 ...
 <div class="row">
	 ...
	 <form action="" autocomplete="off" method="POST">
	  ...
	  if($name=='' && $phone=='') {
	  ?>
	  <button type="submit" name="themvanchuyen" class="btn btn-primary my-3">Thêm vận chuyển</button>
	  <?php
	  } elseif($name!='' && $phone!=''){
	  ?>
	  <button type="submit" name="capnhatvanchuyen" class="btn btn-success my-3">Cập nhật vận chuyển</button>
	  <?php
	  } 
	  ?>
	</form>
